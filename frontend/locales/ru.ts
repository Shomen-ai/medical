...
export default {
  ...
  reviewsFormService: 'Услуга',
  reviewsFormDoctor: 'Врач',
  reviewsFormOptional: 'Не указывать',
  ...
  rfExport: 'Расширенный отчёт',
  rfSheetSummary: 'Сводка',
  rfSheetServices: 'Выручка по услугам',
  rfSheetSpecialty: 'По специальностям',
  rfSheetDoctors: 'По врачам',
  rfSheetDaily: 'Динамика по дням',
  rfSheetTime: 'Загрузка по времени',
  rfSheetRatings: 'Рейтинги',
  rfSheetRetention: 'Новые и повторные',
  rfSheetDemographics: 'Демография',
  rfMetric: 'Показатель',
  rfValue: 'Значение',
  rfTotalAppts: 'Всего приёмов',
  rfRevenueTmt: 'Выручка, TMT',
  rfAvgCheck: 'Средний чек, TMT',
  rfCompletionRate: 'Доля завершённых',
  rfCancelRate: 'Доля отмен',
  rfDate: 'Дата',
  rfByGender: 'По полу',
  rfGender: 'Пол',
  rfByAge: 'По возрасту',
  rfAge: 'Возрастная группа',
  rfGenderM: 'Мужчины',
  rfGenderF: 'Женщины',
  rfGenderUnknown: 'Не указан',
  rfAgeLt18: 'до 18',
  rfAge1830: '18–30',
  rfAge3145: '31–45',
  rfAge4660: '46–60',
  rfAgeGt60: '60+',
  rfService: 'Услуга',
  rfRevenue: 'Выручка, TMT',
  rfByWeekday: 'По дням недели',
  rfByHour: 'По часам',
  rfWeekday: 'День недели',
  rfHour: 'Час',
  rfCount: 'Приёмов',
  rfWeekdays: 'Пн,Вт,Ср,Чт,Пт,Сб,Вс',
  rfByDoctor: 'По врачам',
  rfByService: 'По услугам',
  rfRating: 'Средняя оценка',
  rfReviews: 'Отзывов',
  rfMonth: 'Месяц',
  rfNew: 'Новые пациенты',
  rfReturning: 'Повторные пациенты',
  ...
  profIdDocType: 'Тип документа',
  profIdDocDomestic: 'Внутренний паспорт',
  profIdDocInternational: 'Загранпаспорт',
  profIssuedAt: 'Дата выдачи',
